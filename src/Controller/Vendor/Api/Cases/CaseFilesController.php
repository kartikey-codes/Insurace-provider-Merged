...
namespace App\Controller\Vendor\Api\Cases;
...
class CaseFilesController extends ApiController
{
	 ...
	 * Index / List Files
	 *
	 * @param \App\Service\StorageServiceInterface $storage App storage service.
	 * @return void
	 ...
	 * @throws \League\Flysystem\FilesystemException
	 */
	public function preview(StorageServiceInterface $storage): Response
	{
		$this->getRequest()->allowMethod(['GET']);
