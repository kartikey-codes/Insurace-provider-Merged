...
use App\Factory\ClientEmployeeFactory;
...
class GenerateDemoClientEmployeesCommand extends Command
{
	/**
	 ...
	 * @var string
	 */
	public string $tableName = 'ClientEmployees';
	...
	{
		$this->factory = new ClientEmployeeFactory();
	}
