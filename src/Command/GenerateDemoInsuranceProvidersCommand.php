...
use App\Factory\InsuranceProviderFactory;
...
class GenerateDemoInsuranceProvidersCommand extends Command
{
	/**
	 ...
	 * @var string
	 */
	public string $tableName = 'InsuranceProviders';
	...
	{
		$this->factory = new InsuranceProviderFactory();
	}
