...
class IncomingDocumentListener implements EventListenerInterface
{
	...
	{
		return [
			'Model.IncomingDocument.created'  	=> 'afterCreated',
			'Model.IncomingDocument.modified' 	=> 'afterModified',
		];
	}
