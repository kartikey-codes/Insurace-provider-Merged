	...
	>
		...
		<div>
			...
			<empty-result v-else icon="cloud-upload-alt">
				...
				<template #content> Drag and drop files to attach to this level. </template>
			</empty-result>
		</div>
	</FileManager>
</template>
...
import * as AppealFileService from "@/clients/services/appealFiles";
