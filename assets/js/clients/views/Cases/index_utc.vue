<template>
	...
	>
		...
		<b-container fluid v-else class="my-4">
			<empty-result>
				No UTC cases found
				<template #content> No unable-to-complete cases have been created or match your search. </template>
			</empty-result>
		</b-container>
	</paginated-results>
</template>
...
const filters = reactive({ ...defaultFilters, unable_to_complete: true });
