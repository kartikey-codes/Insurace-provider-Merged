	...
	>
		<b-container fluid class="mt-4">
			<b-row>
				...
				<b-col cols="7" md="6" lg="4" order="2" class="text-left text-md-left text-lg-left">
					...
					<b-button v-if="showDownload" @click="download" :disabled="downloading" title="Download">
						<font-awesome-icon
							:icon="downloading ? 'circle-notch' : 'file-export'"
							:spin="downloading"
							fixed-width
						/>
						<span>Download</span>
				...
				<b-col cols="5" md="6" lg="4" order="3" class="text-right">
		...
		<b-container fluid v-else class="my-4">
			<empty-result>
				No appeals found
				<template #content> No appeals have been created or match your search. </template>
			</empty-result>
		</b-container>
	</paginated-results>
</template>
...
// Hide download for now
// @todo Finish up CSV formatting
