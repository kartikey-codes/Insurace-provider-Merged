<template>
	...
	>
		...
		<b-container fluid v-else class="my-4">
			<empty-result>
				No cancelled appeals found
				<template #content> No cancelled appeals have been created or match your search. </template>
			</empty-result>
		</b-container>
	</paginated-results>
</template>
...
const filters = reactive({ status: "Cancelled", ...defaultFilters });
