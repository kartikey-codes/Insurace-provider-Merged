...
<head>
	...
	<?= $this->element('icons') ?>
	<meta name="api-base-url" content="<?= $this->Url->build('/admin/api', ['fullBase' => true]) ?>">
...
<body class="spa">
	...
	if (!empty($_debugMode) && $_debugMode == true) {
		...
		echo $this->Mix->js('admins.js');
	} else {
		echo $this->Mix->js('vendor.min.js');
		echo $this->Mix->js('admins.min.js');
	}
